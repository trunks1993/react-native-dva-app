...
export async function getList(skillTypeId: number | string): Promise<any> {
  try {
    const response = await fetch(`http://192.168.0.110:8081/terminal/v1/skillLearning/selectLearningType?learningType=1&skillTypeId=${skillTypeId}`, {
      method: 'GET',
      headers: {
...
export async function getCategory(): Promise<any> {
  try {
    const response = await fetch('http://192.168.0.110:8081/terminal/v1/device/treeType/selectAll?treeType=4', {
      method: 'GET',
      headers: {
        Accept: 'application/json',
        'Content-Type': 'application/json',
